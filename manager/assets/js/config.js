!(function () {
  ...
  (this.html = document.getElementsByTagName("html")[0]),
    ...
    (config.theme = e.getAttribute("data-bs-theme") || i.theme),
    (config.topbar.color =
      e.getAttribute("data-topbar-color") || i.topbar.color),
    (config.menu.color = e.getAttribute("data-sidebar-color") || i.menu.color),
    (config.menu.size = e.getAttribute("data-sidebar-size") || i.menu.size),
