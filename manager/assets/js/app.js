    ...
    e &&
      e.forEach(function (i) {
        !(function e() {
          ...
          o < 1 && (o = 1),
            n < t
              ? ((i.innerText = (n + o).toFixed(0)), setTimeout(e, 1))
              : (i.innerText = a(t)),
            a(i.innerText);
        })();
      });
      ...
      document.querySelector(".navbar-nav") &&
        ...
        setTimeout(function () {
          ...
          null != t &&
            ...
            e &&
              100 < t &&
              ((i = 600), (a = (o = e).scrollTop), (c = t - a), (l = 0), r()));
        }, 200));
  }
  initConfig() {
  ...
  setSwitchFromConfig() {
    ...
    o &&
      ...
      (n = document.querySelector(
        "input[type=radio][name=data-sidebar-size][value=" + o.menu.size + "]"
      )),
      (o = document.querySelector(
        "input[type=radio][name=data-sidebar-color][value=" + o.menu.color + "]"
      )),
      e && (e.checked = !0),
      t && (t.checked = !0),
      n && (n.checked = !0),
