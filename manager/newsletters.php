...
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Smile Dove Admin || Subscribed Users For Newsletter</title>
                         ...
                         <div class="card-body">
                              <div class="table-responsive">
                                   <table class="table table-striped w-100" id="tablee">
                                        ...
                                        <tbody>
                                             <?php
                                             $getNewsletter = mysqli_query($conn, "SELECT * FROM `newsletters` ORDER BY `created_at` DESC");
                                             if (mysqli_num_rows($getNewsletter) > 0) {

                                                  while ($row = mysqli_fetch_assoc($getNewsletter)) {
                                                       ?>
                                                       <tr>
