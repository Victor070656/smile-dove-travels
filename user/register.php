...
<!-- Mirrored from stackbros.in/Smile Dove Travels/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Mar 2025 10:05:01 GMT -->

<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Smile Dove User || Sign Up</title>
                ...
                <div class="col-md-6 col-lg-5">
                    <form method="post">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $userid = uniqid();
                            $sql = "INSERT INTO `users` (`userid`, `fullname`, `email`, `password`) VALUES ('$userid','$fullname','$email','$password')";
